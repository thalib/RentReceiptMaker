...
Generate rent receipts instantly, for free, right in your browser. This app is offline-first, mobile-friendly, and privacy-focused—no data ever leaves your device.
...
This will launch the app locally. Visit the URL shown in the terminal (usually http://localhost:5173/) to use the Rent Receipt Generator.

For more technical details, see [`SPEC.md`](./SPEC.md).
